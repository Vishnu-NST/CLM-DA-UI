  ...
  return (
    <div className="card-block">
      <div className="loan-pool-form-block">
        <Grid sx={{display:"flex",justifyContent:"end"}}><CustomButton
        ...
        <ConformationDialogBox
          ...
          // }
          imageComponent={
            openDialog.showImageComponent ? openDialog.imageComponent : null
          }
          ...
          onButtonClick1={() => openDialog?.onButtonClick1 && openDialog.onButtonClick1()}
