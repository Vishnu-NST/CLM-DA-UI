...
export const nbfcNameAttribute = (formik) => {
  return {
    id: "nbfcName",
    name: "nbfcName",
    label: (
    ...
    type: "text",
    value: formik.values.nbfcName,
    onChange: formik.handleChange,
    onBlur: formik.handleBlur,
    error: formik.touched.nbfcName && Boolean(formik.errors.nbfcName),
    helperText: formik.touched.nbfcName && formik.errors.nbfcName,
    disabled: false,
  };
};
...
export const nbfcaddressOneAttribute = (formik) => {
  return {
    id: "nbfcaddressOne",
    name: "nbfcaddressOne",
    label: <div className="input-label">Address 1<span style={{ color: "red" }}>*</span></div>,
    placeholder: "",
    type: "text",
    value: formik.values.nbfcaddressOne,
    onChange: formik.handleChange,
    onBlur: formik.handleBlur,
    error: formik.touched.nbfcaddressOne && Boolean(formik.errors.nbfcaddressOne),
...
export const nbfcaddressTwoAttribute = (formik) => {
  return {
    ...
    onChange: formik.handleChange,
    onBlur: formik.handleBlur,
    error: formik.touched.nbfcaddressTwo && Boolean(formik.errors.nbfcaddressTwo),
...
export const profileStateAttribute = (formik) => {
  return {
    ...
    label: <div className="input-label">State<span style={{ color: "red" }}>*</span></div>,
    placeholder: "",
    type: "text",
    value: formik.values.profileStateAttribute,
    onChange: formik.handleChange,
    onBlur: formik.handleBlur,
    error: formik.touched.profileStateAttribute && Boolean(formik.errors.profileStateAttribute),
    helperText: formik.touched.profileStateAttribute && formik.errors.profileStateAttribute,
    disabled: false,
  };
};
export const profileCityAttribute = (formik) => {
  return {
    id: "profileCity",
    name: "profileCity",
    label: <div className="input-label">City<span style={{ color: "red" }}>*</span></div>,
    placeholder: "",
    type: "text",
...
export const profilePincodeAttribute = (formik) => {
  return {
    id: "profilePincode",
    name: "profilePincode",
    label: <div className="input-label">Pin code<span style={{ color: "red" }}>*</span></div>,
    placeholder: "",
    type: "number",
    value: formik.values.profilePincode,
    onChange: formik.handleChange,
    onBlur: formik.handleBlur,
    error: formik.touched.profilePincode && Boolean(formik.errors.profilePincode),
