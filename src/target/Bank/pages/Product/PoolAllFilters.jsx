...
import {
	...
	par90PlusAttribute,
} from './utils/filterFormAttributes';
...
const PoolAllFilter = ({ handleClose, isOpen }) => {
	...
	const handleButtonClick = () => {
		setPopupOpen(!isPopupOpen); // Toggle the state to open/close the popup
	};
	const handleCloseIconClick = () => {
		setPopupOpen(false); // Close the popup when the close icon is clicked
	};
	return (
