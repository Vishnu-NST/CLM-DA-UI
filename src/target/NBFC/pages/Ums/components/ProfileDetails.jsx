...
import useGetOrg from '@/store/useGetOrg';
...
export const ProfileDetails = () => {
	...
	if (getOrgQuery.isSuccess) {
		//
	}

	console.log(getOrgQuery.data);
								...
								<div style={div3Style}>
									...
									<div style={{ padding: '1rem 0rem 0rem' }}>
										...
										Road, Bangalore, Karnataka */}
											{getOrgQuery.data.address_one}{' '}
											{getOrgQuery.data.address_two}{' '}
											{getOrgQuery.data.pincode}{' '}
											{getOrgQuery.data.state}
										</Typography>
									</div>
								</div>
							</div>
						...
						<div style={bottomDiv}>
							<Grid container spacing={3}>
								...
								<Grid item xs={3} align="left">
									...
									>
										{getOrgQuery.data.dateof_incorporation}
									</Typography>
									<Typography
										sx={{
											color: '#8794C2',
								...
								<Grid item xs={3} align="left">
									...
									>
										{getOrgQuery.data.number_of_employees}
									</Typography>
									<Typography
										sx={{
											color: '#8794C2',
								...
								<Grid item xs={3} align="left">
									...
									>
										{getOrgQuery.data.registration_number ?? 10}
									</Typography>
									<Typography
										sx={{
											color: '#8794C2',
								...
								<Grid item xs={3} align="left">
									...
									>
										{getOrgQuery.data.registration_number}
									</Typography>
									<Typography
										sx={{
											color: '#8794C2',
								...
								<Grid item xs={3} align="left">
									...
									>
										{getOrgQuery.data.class_of_company}
									</Typography>
									<Typography
										sx={{
											color: '#8794C2',
