...
import ReusableUserCard from '@/NBFC/components/ReusableUserCard';
import CardIcon from '@/NBFC/assets/svg/CardIcon';
import { Grid } from '@mui/material';
import ConformationDialogBox from '@/NBFC/components/ConformationDialogBox';
import SuccessIcon from '@/NBFC/assets/svg/SuccessIcon';
import ForwardArrow from '@/NBFC/assets/svg/ForwardArrow';
import { useNavigate } from 'react-router-dom';
import CustomButton from '@/NBFC/components/CustomButton';
import SuccessDltIcon from '@/NBFC/assets/svg/SuccessDltIcon';
const UserList = () => {
